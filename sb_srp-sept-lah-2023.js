$('.facet-field').each(function() {
  // do something with the current li element
    //$( this ).addClass('inn');
    ///$( this ).attr("data-facetexpanded",true); //setter; //setter
 console.log("bbbbbbng-cloak");
});//$('.facet-field').each(function() {



 var process_search_results = function(field, bib) {
        console.log("field,bib", field, bib);
            ...
            if (bib.marc.has('856')) { //(R)
                ...
                bib.marc.fields('856').forEach(function(field, i) {
                    if (field.subfield('856u') !== undefined && field.subfield('856u') !== null) {
                        properlyFormattedHtmlString = '<span>' + '<a class="u856u" title="' + field.subfield('856u') + '"  href="' + field.subfield('856u') + '">' + field.subfield('856u') + '</a>' + '</span> ';
                    }
                    if (field.subfield('8563') !== undefined && field.subfield('8563') !== null) {
                        properlyFormattedHtmlString = '<span>' + '<a class="u8563" title="' + field.subfield('856u') + '"  href="' + field.subfield('856u') + '">' + field.subfield('8563') + '</a>' + '</span> ';
                    }
                    //new code below as of 8/3/2015
                    if (field.subfield('856z') !== undefined && field.subfield('856z') !== null) {
                        properlyFormattedHtmlString = '<span>' + '<a class="u856z" title="' + field.subfield('856u') + '"  href="' + field.subfield('856u') + '">' + field.subfield('856z') + '</a>' + '</span> ';
                    }
        ...
        var friendly_print_resource_type = function(bib) {
            ...
            var htmlstring = '<span class="gen_info_labelSRP paddingRight2">Type: </span> ' +
                ' <img src="https://libweb.hartford.edu/koha/icons/' + which_resource_type_icon +
        ...
        var getbibRecordFormat = function(bib) {
            ...
            if (bib.marc.rtype() === 'BKS' || bib.marc.rtype() === 'SER' || bib.marc.rtype() === 'SCO') {
                ...
                if (has008 == true) {
                    ...
                    if (bib.marc.ctrl('008[24]') === 'b' || bib.marc.ctrl('008[25]') === 'b' || bib.marc.ctrl('008[26]') === 'b' || bib.marc.ctrl('008[27]') === 'b') {
                        ...
                        thebibRecordFormat = thebibRecordFormat + ' <img src="https://libweb.hartford.edu/koha/icons/text_list_bullets.png" alt="bibliography" title="bibliography"> ' + ' Bibliography';
                    }
            ...
            if (has007 == true) { //has007 =="T"
                ...
                if (bib.marc.ctrl('007[0]') === 'c' && bib.marc.ctrl('007[1]') === 'r') { // Remote test
                    ...
                    thebibRecordFormat = thebibRecordFormat + ' <img src="https://libweb.hartford.edu/koha/icons/drive_web.png" alt="Remote" title="Remote"> ' + 'Remote | ';
                }
                ...
                if (bib.marc.ctrl('007[0]') === 'v' && bib.marc.ctrl('007[1]') === 'f') { // Videocassette test
                    ...
                    thebibRecordFormat = thebibRecordFormat + ' <img src="https://libweb.hartford.edu/koha/icons/videocassette.png" alt="videocassette" title="videocassette"> ' + 'Videocassette | ';
                }
                if (bib.marc.ctrl('007[0]') === 'v' && bib.marc.ctrl('007[1]') === 'd') { // Videodisc test
                    // 007/00 =v   AND   007/01=d -> Videodisc
                    thebibRecordFormat = thebibRecordFormat + ' <img src="https://libweb.hartford.edu/koha/icons/dvd.png" alt="DVD" title="DVD"> ' + 'Videodisc | ';
                }
                ...
                if ((bib.marc.ctrl('007[0]') === 's' && bib.marc.ctrl('007[1]') === 'd' && bib.marc.ctrl('007[3]') === 'f')) { // CD test
                    thebibRecordFormat = thebibRecordFormat + ' <img src="https://libweb.hartford.edu/koha/icons/cd.png" alt="CD" title="CD"> ' + ' CD | ';
                    cdFound = true;
                }
                if ((bib.marc.ctrl('007[0]') === 's' && bib.marc.ctrl('007[1]') === 'd' && bib.marc.ctrl('007[3]') === 'b')) { // LP test
                    thebibRecordFormat = thebibRecordFormat + ' <img src="https://libweb.hartford.edu/koha/icons/lp.png" alt="LP" title="LP"> ' + ' LP / Vinyl | ';
                    lpFound = true;
                }
            } //has007 =="T"
            if (cdFound === false) {
                ...
                if (bib.marc.rtype() === 'BKS') { //if 3
                    if (bib.marc.ctrl('008[24]') !== 'number_sign' && bib.marc.ctrl('008[24]') !== ' ' && bib.marc.ctrl('008[24]') !== '|' && bib.marc.ctrl('008[24]') != 'u') { //if 5
                        ...
                        properlyFormattedHtmlString = '<span class="main_divider">|</span><span class="gen_info_labelSRP paddingRight2">Nature of contents: </span>' +
                            '<img src="https://libweb.hartford.edu/koha/icons/user.png" alt="NOC" title="NOC"> ' + '<span class="gen_info_dataitemSRP indent_data">' + thebibRecordNatureOfContents + '</span>';
                    } //if 5
                } //if 3
            } //if 0
            return properlyFormattedHtmlString;
            ...
            if (bib.marc.has('008')) { //if 0
                if (bib.marc.rtype() === 'SER') {
                    ...
                    if (bib.marc.ctrl('008[21]') !== ' ' && bib.marc.ctrl('008[21]') !== 'z' && bib.marc.ctrl('008[21]') !== '|') {
                        theTypeofContRes = ' <img src="https://libweb.hartford.edu/koha/icons/' + TypeofContResImage[bib.marc.ctrl('008[21]')] + '"alt="' +
    ...
    var addMfhdTable = function(data) {
            ...
            //??????????????????????????????????????????????????????????????????????????????????????????????????????????????
            var MfhdTableTop = '<table id="' + uniqueTableID + '" class="srptable2 ' + ' table-striped">\
...
/*
{id: '697424', onloan: null, itemlost: null, holdingbranch: 'ALLEN', on_holdshelf: null, â€¦}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        var addItemsTable = function(data) {
            ...
            console.log("2020 just entered addItemsTable = function(data) and data =", data);
            ...
            //???????????????????????????????????????????????????????????????????????????????????????????????????
            var ItemsTableTop = '<table id="' + uniqueTableID + '" class="srptable2  ' + uniqueTableClass + ' table-striped">\
...
if(navigator.userAgent =='Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5060.134 Safari/537.36 OPR/89.0.4447.83NOEXECUTERIGHTNOW'){
    ...
    /////////////////////////////////////////////////////// var addItems_or_Mfhd_Table = function(bib) ///////////////////////////////////////////////////////////    
        var addItems_or_Mfhd_Table = function(bib) {
            console.log("2235 addItems_or_Mfhd_Table", bib);
            ...
            if (bib.marc.leader().substr(6, 2) === 'ab' || bib.marc.leader().substr(6, 2) === 'ai' || bib.marc.leader().substr(6, 2) === 'as') {
                $.getJSON(theMFHDsURL, function(data) { //outer JSON
                    if (data.length !== 0) { //999 if(data.length===0){
                        console.log("2241 addItems_or_Mfhd_Table", data);
                        addMfhdTable(data);
                    } else {
                        $.getJSON(theItemsURL, function(data) {
                            console.log("2245 getJSON(theItemsURL", theItemsURL, data);
                ...
                $.getJSON(theItemsURL, function(data) { //outer JSON
                    console.log("2259 getJSON(theItemsURL", theItemsURL, data);
                    if (data.length !== 0) { //if(data.length===0){
                        addItemsTable(data);
                    } else {
                        var moreDetails = '<br><span><a href="/app/work/' + bib.id + '">More Details</a></span>';
...
console.log("Pager",$('.textwrap').css('margin-left')  );

if( $('body').width() >= 576 ) $('.bottomPager').css('margin-left' ,  $('.textwrap').css('margin-left')  ); //search-results-select-holder textwrap
if( $('body').width() < 576 ) $('.bottomPager').css('margin-left' ,  4 + 'px'  ); //search-results-select-holder textwrap
}//if(  window.location.pathname.includes('/app/search')  ){    
